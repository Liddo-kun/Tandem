...
// UPSTREAM-DIVERGENCE: Tandem mobile wrappers identify as ios/android platforms.
type PlatformName = "web" | "desktop" | "ios" | "android"
type DesktopOS = "macos" | "windows" | "linux"
type PlatformOS = DesktopOS | "ios" | "android"
...
export type Platform = PlatformBase &
  (
    ...
    // UPSTREAM-DIVERGENCE: Tandem mobile wrappers identify as ios/android.
    | { platform: "ios" | "android"; os?: "ios" | "android" }
  )
