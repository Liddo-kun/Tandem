...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const useV2Input = () =>
    import.meta.env.VITE_TANDEM_ANDROID_V2_ONLY === "true" || settings.general.newLayoutDesigns()
    ...
    <Show when={store.mode === "normal" && mobile() && platform.startVoiceInput}>
      <Tooltip placement="top" value="Voice input">
        <IconButton
          ...
          class={
            variant === "v2"
              ? "size-7 rounded-md p-[6px] text-v2-icon-icon-muted"
              : "size-8 rounded-md p-[6px]"
          }
