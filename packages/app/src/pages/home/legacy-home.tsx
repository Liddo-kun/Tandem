...
// UPSTREAM-DIVERGENCE: Tandem's parallel-install web port, shown as mobile connection help.
...
export function LegacyHome() {
  ...
  return (
    <div class="mx-auto mt-55 w-full md:w-auto px-4">
      {/* UPSTREAM-DIVERGENCE: Tandem text wordmark instead of the OpenCode logo. */}
      ...
      {/* UPSTREAM-DIVERGENCE: mobile connection help for the Tandem/OpenCode server. */}
