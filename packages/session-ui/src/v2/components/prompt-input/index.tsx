...
export type PromptInputV2Props = {
  ...
  // UPSTREAM-DIVERGENCE: Tandem control slots. `leadingControls` hosts the native mobile mic
  // button, `trailingControls` the cache-health context button and RePrompt toggle, so the app
  // can extend the composer row without forking this component.
  ...
  return (
    ...
    >
      <IconButton
        ...
        // width-constrained control row overflows and a trailing control overlaps it.
