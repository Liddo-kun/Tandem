...
const icons = {
  ...
  // UPSTREAM-DIVERGENCE: Tandem manual session refresh; mirrors the legacy icon set's `refresh`.
  refresh: {
    viewBox: "0 0 20 20",
    body: `<path d="M15.625 7.5C14.9093 5.6714 13.1309 4.375 11.0417 4.375C8.31925 4.375 6.02187 6.5782 5.91903 9.2987M4.375 7.5V10.625H7.5M4.375 12.5C5.09066 14.3286 6.86913 15.625 8.95833 15.625C11.6808 15.625 13.9781 13.4218 14.081 10.7013M15.625 12.5V9.375H12.5" stroke="currentColor" stroke-linecap="square"/>`,
  },
  archive: {
    viewBox: "0 0 16 16",
