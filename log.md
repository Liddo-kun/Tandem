...
- Adds Android debug build/install helpers, including side-by-side Y700 variant builds that restore generated metadata and save full logs. Files: `packages/android/build-and-install.sh`, `packages/android/install-y700-variant.ps1`, `packages/android/generate-icons.py`.
