...
- Stabilizes Android keyboard resizing and viewport behavior by making the WebView root follow `visualViewport`, applying generated Android patches before Tauri commands, refreshing scroll-bottom state when the viewport changes, and disabling Android page pinch zoom. Files: `packages/android/index.html`, `packages/android/src/entry-android.tsx`, `packages/android/package.json`, `packages/android/patch-android-generated.ts`, `packages/android/src-tauri/templates/MainActivity.kt`, `packages/ui/src/hooks/create-auto-scroll.tsx`.
...
- Adds mobile-aware reversed timeline scrolling, bottom detection, prompt and nested scroll gesture protection, and scroll-view keyboard endpoints for iOS/Android positive scroll offsets. Files: `packages/app/src/components/prompt-input.tsx`, `packages/app/src/pages/session.tsx`, `packages/app/src/pages/session/message-timeline.tsx`, `packages/ui/src/components/scroll-view.tsx`, `packages/ui/src/components/scroll-view.css`, `packages/ui/src/hooks/create-auto-scroll.tsx`.
